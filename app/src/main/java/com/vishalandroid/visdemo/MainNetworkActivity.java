...
public class MainNetworkActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        if (st_username.equalsIgnoreCase("admin") && st_password.equalsIgnoreCase("admin")){
            ...
            if (addOrderList.size() == 0){
                ...
                Intent i = new Intent(MainNetworkActivity.this,HomeActivity.class);
                startActivity(i);
                finish();
            ...
            Toast.makeText(MainNetworkActivity.this, "Please enter user name and password", Toast.LENGTH_SHORT).show();
    ...
    private void netwrokCall() {
        ...
        Call<abc> getDataCall = apiInterface.getdata();

        getDataCall.enqueue(new Callback<abc>() {
            @Override
            public void onResponse(Call<abc> call, Response<abc> response) {
                ...
                if (response.code() == 200){
                    ...
                    List<abc.LabelsEntity> labelsEntities = response.body().getData();

                    for (abc.LabelsEntity  data : labelsEntities){
                    ...
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(MainNetworkActivity.this, "No Response Found", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<abc> call, Throwable t) {
                ...
                Toast.makeText(MainNetworkActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
